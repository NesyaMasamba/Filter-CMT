...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/+O93D3rhIsbgwYjM1"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/+O93D3rhIsbgwYjM1")
            ])
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                ...
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/RequestMovie84')
            ],
            [
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Request Movie 🎬', url='https://t.me/RequestMovie84')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/Collection_MovieTerbaik/26748'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/Collection_MovieTerbaik")
    ])
